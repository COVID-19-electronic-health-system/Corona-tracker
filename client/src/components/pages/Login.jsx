...
const useStyles = makeStyles((theme) => ({
  ...
  "@keyframes glowing": {
    ...
    "50%": {
      ...
      boxShadow: "0px 1px 13px 3px #4760ff",
    },
    "100%": {
      backgroundColor: "#2ba805",
      boxShadow: "0px 1px 10px 0px #4760ff",
    ...
    <div className={classes.Login}>
      <div>
        ...
        <Typography variant="h6">
          <Trans i18nKey="loginSection.text.title.yourHealthAppToMonitorFluLikeSymptomsConnectToTelehealthDoctorsInYourAreaAndDiscoverResourcesCloseToYou" />
        </Typography>
        <Button variant="login" className={classes.Button} onClick={onClick}>
          <Trans i18nKey="loginSection.text.button.getStarted" />
        </Button>
        <TranslationsMenu />
        <Typography>
          <Trans i18nKey="loginSection.text.logMobile.ifOnMobilePleaseDisablePopupsForBestUse" />
        </Typography>
      </div>
    </div>
  );
