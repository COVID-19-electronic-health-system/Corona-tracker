...
export default function BehavioralChart () {
   ...
   const handleChange = evt =>  {
    ...
    console.log(targetName)
      ...
      if (targetName === "interest"){setInterest(!interest)}
      else if (targetName === "sadness"){setSadness(!sadness)}
      else if (targetName === "sleep"){setSleep(!sleep)}
      else if (targetName === "energy"){setEnergy(!energy)}
      else if (targetName === "appetite") {setAppetite(!appetite)} 
