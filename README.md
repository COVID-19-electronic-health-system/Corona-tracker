...
Use /css/themePalette.css and its classes to style the components. Then add your custom css file after that. Remember that css cascades and overrides. So, add the themePalette.css, first then the component's css file.  
